...
Use omz's canonical advisor skill to route a prompt through the local Claude, Codex, Gemini, Antigravity, Grok, or Cursor CLI and persist the result as an ask artifact.

## Usage

```bash
/omz:ask <claude|codex|gemini|antigravity|grok|cursor> <question or task>
```

Examples:

```bash
/omz:ask codex "review this patch from a security perspective"
/omz:ask gemini "suggest UX improvements for this flow"
/omz:ask antigravity "suggest UX improvements for this flow"
/omz:ask claude "draft an implementation plan for issue #123"
/omz:ask cursor "apply this implementation plan"
```
