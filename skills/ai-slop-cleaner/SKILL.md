...
Use this skill to clean AI-generated code slop without drifting scope or changing intended behavior. In omz, this is the bounded cleanup workflow for code that works but feels bloated, repetitive, weakly tested, or over-abstracted.
...
- Good fit: `omz:ai-slop-cleaner skills/ralph/SKILL.md skills/ai-slop-cleaner/SKILL.md`
...
- `/omz:ai-slop-cleaner <target>`
- `/omz:ai-slop-cleaner <target> --review`
- `/omz:ai-slop-cleaner <file-a> <file-b> <file-c>`
